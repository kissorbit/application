    ...
    public function CreateOrUpdate(Request $request)
    {
        try {
            if($request['id'] !=''):
                ...
                $Lsps->compagny_name=strip_tags($request["compagny_name"]);$Lsps->compagny_address=strip_tags($request["compagny_address"]);$Lsps->name=strip_tags($request["name"]);$Lsps->first_name=strip_tags($request["first_name"]);$Lsps->email=strip_tags($request["email"]);$Lsps->phone=strip_tags($request["phone"]);$Lsps->country=strip_tags($request["country"]);$Lsps->city=strip_tags($request["city"]);
                $Lsps->save();
