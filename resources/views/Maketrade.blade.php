...
<script stype="text/javascript">
    ...
    $scope.user = [];
    $scope.Submitlsr={!! App\Submitlsr::all()->toJson() !!};
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form  ng-app="ngMaketradeApp" ng-controller="ngMaketradeAppcontroller" id="Maketrade-form" class="form-horizontal form-label-left" method="post" action='{!! route("Maketradecreateorupdate") !!}' autocomplete="off">
                        ...
                        <div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-12" for="trade_lsr_select"> Open LSR <span class="required">*</span></label><div class="col-md-6 col-sm-6 col-xs-12"><select  class="form-control col-md-7 col-xs-12" id="trade_lsr_select" name="trade_lsr_select"><option ng-selected="MaketradeItem.trade_lsr_select==Submitlsritem.id" ng-repeat=" Submitlsritem in Submitlsr" class="form-control col-md-7 col-xs-12" value="<% Submitlsritem.id %>" ><% Submitlsritem.goods_lsr_observations %></option></select></div></div>
...
<script type="text/javascript">
            ...
            dom: '<"row"<"col-sm-7 col-md-8"<"hidden-xs hidden-sm"l>B><"col-sm-5 col-md-4"f>><"row"<"col-sm-12 table-responsive"rt>><"row"<"col-sm-5"i><"col-sm-7"p>>',
                    ...
                    {data: 'id', name: 'id'},
                    {data: 'trade_lsr_select.goods_lsr_observations', name: 'trade_lsr_select'},
