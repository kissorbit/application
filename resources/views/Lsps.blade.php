                        ...
                        <table class="table table-striped responsive-utilities jambo_table dataTable" id="Lsps-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>ID</th>
                                    <th>Compagny name</th><th>Compagny addresse</th><th>Name</th><th>First Name</th><th>Email</th><th>Phone</th><th>Country</th><th>City</th>
                                    <th>Created At</th>
                                    <th>Updated At</th>
                                    <th>Actions</th>
                                </tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form  ng-app="ngLspsApp" ng-controller="ngLspsAppcontroller" id="Lsps-form" class="form-horizontal form-label-left" method="post" action='{!! route("Lspscreateorupdate") !!}' autocomplete="off">
                        ...
                        <div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-12" for="compagny_name"> Compagny name <span class="required">*</span></label><div class="col-md-6 col-sm-6 col-xs-12"><input ng-model="LspsItem.compagny_name" type="text" id="compagny_name" name="compagny_name" required="required" class="form-control col-md-7 col-xs-12" ></div></div><div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-12" for="compagny_address"> Compagny addresse <span class="required">*</span></label><div class="col-md-6 col-sm-6 col-xs-12"><input ng-model="LspsItem.compagny_address" type="text" id="compagny_address" name="compagny_address" required="required" class="form-control col-md-7 col-xs-12" ></div></div><div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> Name <span class="required">*</span></label><div class="col-md-6 col-sm-6 col-xs-12"><input ng-model="LspsItem.name" type="text" id="name" name="name" required="required" class="form-control col-md-7 col-xs-12" ></div></div><div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-12" for="first_name"> First Name <span class="required">*</span></label><div class="col-md-6 col-sm-6 col-xs-12"><input ng-model="LspsItem.first_name" type="text" id="first_name" name="first_name" required="required" class="form-control col-md-7 col-xs-12" ></div></div><div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-12" for="email"> Email <span class="required">*</span></label><div class="col-md-6 col-sm-6 col-xs-12"><input ng-model="LspsItem.email" type="text" id="email" name="email" required="required" class="form-control col-md-7 col-xs-12" ></div></div><div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-12" for="phone"> Phone <span class="required">*</span></label><div class="col-md-6 col-sm-6 col-xs-12"><input ng-model="LspsItem.phone" type="text" id="phone" name="phone" required="required" class="form-control col-md-7 col-xs-12" ></div></div><div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-12" for="country"> Country <span class="required">*</span></label><div class="col-md-6 col-sm-6 col-xs-12"><input ng-model="LspsItem.country" type="text" id="country" name="country" required="required" class="form-control col-md-7 col-xs-12" ></div></div><div class="form-group"><label class="control-label col-md-3 col-sm-3 col-xs-12" for="city"> City <span class="required">*</span></label><div class="col-md-6 col-sm-6 col-xs-12"><input ng-model="LspsItem.city" type="text" id="city" name="city" required="required" class="form-control col-md-7 col-xs-12" ></div></div>
...
<script type="text/javascript">
            ...
            dom: '<"row"<"col-sm-7 col-md-8"<"hidden-xs hidden-sm"l>B><"col-sm-5 col-md-4"f>><"row"<"col-sm-12 table-responsive"rt>><"row"<"col-sm-5"i><"col-sm-7"p>>',
                    ...
                    {data: 'id', name: 'id'},
                    {data: 'compagny_name', name: 'compagny_name'},{data: 'compagny_address', name: 'compagny_address'},{data: 'name', name: 'name'},{data: 'first_name', name: 'first_name'},{data: 'email', name: 'email'},{data: 'phone', name: 'phone'},{data: 'country', name: 'country'},{data: 'city', name: 'city'},
